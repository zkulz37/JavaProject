	...
	<div class="header">
		...
		<div class="container">
			<div class="h_menu4">
				...
				<ul class="nav">
					<li class="active"><a href="index.jsp"><i> </i>MENU</a></li>
					<li ><a href="#" >PRODUCT</a>
						...
						<li><a href="products.jsp" >INFORMATION</a></li>            							  				 
						<li><a href="products.jsp" >NEWS</a></li>
						<li><a href="products.jsp" >DỊCH VỤ</a></li>
						<li><a href="products.jsp" >TUYỂN DỤNG</a></li>
						<li><a href="contact.jsp" >HOTLINE</a></li>
